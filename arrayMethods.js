...
const withTax = orders.map(function(elem){return elem.price + (elem.price * elem.tax)});
console.log(withTax);
...
const bobsTotal = purchases.filter (function (elem){return elem.owner === "Bob"})
.reduce (function (acc, elem){return acc + elem.price}, 0);
